			...
			<form class="row g-3" action="updateListing.do" method="POST">
				...
				<div class="col-md-12">
					...
					<label for="street" class="form-label">Street</label> <input
						type="text" class="form-control" name="street" required value="${listing.address.street }">
				</div>
				...
				<div class="col-md-6">
					<label for="city" class="form-label">City</label> <input
						type="text" class="form-control" name="city" required value="${listing.address.city }">
				</div>
				<br>
				<div class="col-md-3">
				...
				<div class="col-md-3">
					<label for="postalCode" class="form-label">Zip Code</label> <input
						type="number" class="form-control" required name="postalCode" value="${listing.address.postalCode }">
				</div>
